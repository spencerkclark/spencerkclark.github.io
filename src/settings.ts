export const profile = {
	...
	focus is advancing the capabilities of the \
	[Ai2 Climate Emulator (ACE)](https://github.com/ai2cm/ace) as part of \
	our 10-person team.'
}
...
export const seo = {
	default_title: 'Spencer K. Clark',
	default_description: 'Website',
	default_image: '/sphere_square.png',
}
